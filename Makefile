...
CXXFLAGS = -std=c++20 -Iminhook/include -Idiscord/c -Wall -Ofast -target ${TARGET} -DWIN32_LEAN_AND_MEAN -D_WIN32_WINNT=_WIN32_WINNT_WIN7
LDFLAGS := -shared -static -static-libgcc -s -pthread -lgdi32 -ldwmapi discord/lib/x86_64/discord_game_sdk.dll.lib
